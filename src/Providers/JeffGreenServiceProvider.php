...
/**
 * Class JeffGreenServiceProvider
 * @package JeffGreen\Providers
 */
class JeffGreenServiceProvider extends ServiceProvider
{
    const PRIORITY = 0;
    ...
    public function boot(Twig $twig, Dispatcher $dispatcher, ConfigRepository $config)
    {
        ...
        $enabledOverrides = explode(", ", $config->get("JeffGreen.templates.override"));

        // Override partials
        $dispatcher->listen('IO.init.templates', function (Partial $partial) use ($enabledOverrides)
        {
            pluginApp(Container::class)->register('JeffGreen::PageDesign.Partials.Header.NavigationList.twig', NavigationCacheSettings::class);
            pluginApp(Container::class)->register('JeffGreen::PageDesign.Partials.Header.SideNavigation.twig', SideNavigationCacheSettings::class);
            ...
            {
                $partial->set('head', 'JeffGreen::PageDesign.Partials.Head');
            }

            if (in_array("header", $enabledOverrides) || in_array("all", $enabledOverrides))
            {
                $partial->set('header', 'JeffGreen::PageDesign.Partials.Header.Header');
            }

            if (in_array("page_design", $enabledOverrides) || in_array("all", $enabledOverrides))
            {
                $partial->set('page-design', 'JeffGreen::PageDesign.PageDesign');
            }

            if (in_array("footer", $enabledOverrides) || in_array("all", $enabledOverrides))
            {
                $partial->set('footer', 'JeffGreen::PageDesign.Partials.Footer');
            }
        ...
        if (in_array("homepage", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('JeffGreen::Homepage.Homepage');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("category_content", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('JeffGreen::Category.Content.CategoryContent');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("category_view", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('JeffGreen::Category.Item.CategoryItem');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("basket", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('JeffGreen::Basket.Basket');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("checkout", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('JeffGreen::Checkout.Checkout');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("order_confirmation", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('JeffGreen::Checkout.OrderConfirmation');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("login", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('JeffGreen::Customer.Login');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("register", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('JeffGreen::Customer.Register');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("item", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('JeffGreen::Item.SingleItemWrapper');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("search", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('JeffGreen::ItemList.ItemListView');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("my_account", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('JeffGreen::MyAccount.MyAccount');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("wish_list", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('JeffGreen::WishList.WishListView');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("contact", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('JeffGreen::Customer.Contact');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("order_return", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('JeffGreen::OrderReturn.OrderReturnView');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("order_return_confirmation", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('JeffGreen::OrderReturn.OrderReturnConfirmation');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("cancellation_rights", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('JeffGreen::StaticPages.CancellationRights');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("cancellation_form", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('JeffGreen::StaticPages.CancellationForm');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("legal_disclosure", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('JeffGreen::StaticPages.LegalDisclosure');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("privacy_policy", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('JeffGreen::StaticPages.PrivacyPolicy');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("terms_conditions", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('JeffGreen::StaticPages.TermsAndConditions');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("item_not_found", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('JeffGreen::StaticPages.ItemNotFound');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("page_not_found", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('JeffGreen::StaticPages.PageNotFound');
                return false;
            }, self::PRIORITY);
        }
        ...
        if (in_array("newsletter_opt_out", $enabledOverrides) || in_array("all", $enabledOverrides))
        {
            ...
            {
                $container->setTemplate('JeffGreen::Newsletter.NewsletterOptOut');
                return false;
            }, self::PRIORITY);
        }

        $enabledResultFields = explode(", ", $config->get("JeffGreen.result_fields.override"));
        ...
        if (in_array("auto_complete_list_item", $enabledResultFields) || in_array("all", $enabledResultFields))
        {
          ...
          {
              $templateContainer->setTemplate(ResultFieldTemplate::TEMPLATE_AUTOCOMPLETE_ITEM_LIST, 'JeffGreen::ResultFields.AutoCompleteListItem');
              return false;
          });
        }
        ...
        if (in_array("basket_item", $enabledResultFields) || in_array("all", $enabledResultFields))
        {
          ...
          {
              $templateContainer->setTemplate(ResultFieldTemplate::TEMPLATE_BASKET_ITEM, 'JeffGreen::ResultFields.BasketItem');
              return false;
          });
        }
        ...
        if (in_array("category_tree", $enabledResultFields) || in_array("all", $enabledResultFields))
        {
          ...
          {
              $templateContainer->setTemplate(ResultFieldTemplate::TEMPLATE_CATEGORY_TREE, 'JeffGreen::ResultFields.CategoryTree');
              return false;
          });
        }
        ...
        if (in_array("list_item", $enabledResultFields) || in_array("all", $enabledResultFields))
        {
          ...
          {
              $templateContainer->setTemplate(ResultFieldTemplate::TEMPLATE_LIST_ITEM, 'JeffGreen::ResultFields.ListItem');
              return false;
          });
        }
        ...
        if (in_array("single_item", $enabledResultFields) || in_array("all", $enabledResultFields))
        {
          ...
          {
              $templateContainer->setTemplate(ResultFieldTemplate::TEMPLATE_SINGLE_ITEM, 'JeffGreen::ResultFields.SingleItem');
              return false;
          });
        }
    }
